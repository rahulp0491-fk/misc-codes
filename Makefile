...
OBJS = $(NT_OBJS) $(SM_OBJS) $(GT_OBJS) $(GT_APP_OBJS)
...
GT_APP_DEPS = $(GT_DIR)/applications.cpp $(GT_DIR)/graph_common.h
...
$(GRAPH_APP) : $(GT_APP_OBJS) 
	$(CC) $(LFLAGS) $(GT_APP_OBJS) $(OBJECT) $(EXEC_NAME)
